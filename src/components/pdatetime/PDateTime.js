...
import FormioUtils from 'util';
import Widgets from '../../widgets';
import TableComponent from '../table/Table';
import Components from '../Components';
import DateTime from '../datetime/DateTime';

export default class PDateTime extends DateTime {
    ...
    static get builderInfo() {
        return {
            ...
            schema: PDateTime.schema()
        };
    }
}

PDateTime.editForm = TableComponent.editForm;

Components.addComponent('PDateTime', PDateTime);
